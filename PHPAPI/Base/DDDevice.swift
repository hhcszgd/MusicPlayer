...
class DDDevice: UIDevice {
    class var scale : CGFloat{
        ...
        func gotResourceInSubBundle(_ name : String,type : String,directory : String?) -> String? {
            let bundle : Bundle = Bundle.main      //refreshBundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[MJRefreshComponent class]] pathForResource:@"MJRefresh" ofType:@"bundle"]];
